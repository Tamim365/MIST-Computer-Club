...
<!-- CSS Here -->
   ...
   <!-- SlickNav.css -->
   <link rel="stylesheet" href="Home/assets/css/slicknav.min.css">
   <!-- Owl.carousel.css -->
   <link rel="stylesheet" href="Home/assets/css/owl.carousel-2.3.4.min.css">
   <!-- Fontawesome.css -->
   <link rel="stylesheet" href="Home/assets/css/fontawesome-free-5.12.0.min.css">
   <!-- Bootstrap.css -->
   <link rel="stylesheet" href="Home/assets/css/bootstrap-4.3.1.min.css">
   <!-- Default.css -->
   ...
   <!-- ColorNip.css -->
   <link rel="stylesheet" href="Home/assets/css/colornip.min.css">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-1">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="fab fa-cuttlefish"></i> Contest Programming</h6>
                            <div class="iconbox-content-body">
                                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae fugit aut quas quia, porro obcaecati?</p>
                ...
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-2">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="fas fa-mobile"></i> App development</h6>
                            <div class="iconbox-content-body">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque maxime perferendis quos totam. Illum, non?</p>
                                <a class="btn btn-inline read-more-btn" href="#"><i class="fas fa-plus-square"></i> Read More</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="single-icon-box icon-box-img-3">
                        <div class="icon-box-content">
                            <h6 class="iconbox-content-heading"><i class="fas fa-gamepad"></i> Game Development</h6>
                            <div class="iconbox-content-body">
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti maxime sint tempora tenetur tempore deleniti!</p>
                                <a class="btn btn-inline read-more-btn" href="#"><i class="fas fa-plus-square"></i> Read More</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-none d-md-block">
                    <div class="hire-us-img">
                        <img src="Home/assets/img/hire_us.png" alt="">
                    </div>
                </div>
            </div>
        </div> -->
                    ...
                    <div class="blog-carousel owl-carousel">
                        <div class="single-blog-item">
                            <div class="single-blog-img">
                                <img src="Home/assets/img/urcwin.jpg" alt="">
                                <span>9 June, 2021</span>
                            </div>
                            <div class="blog-content">
                                <h5 class="post-heading"><a href="#">MIST's rover team, Mongol Barota, ranked first in the University Rover
                                Challenge (URC) 2021.</a> </h5>
                        ...
                        <div class="single-blog-item">
                            <div class="single-blog-img">
                                <img src="Home/assets/img/uvcwin.jpg" alt="">
                                <span>March 16, 2021</span>
                            </div>
                            <div class="blog-content">
                                <h5 class="post-heading"><a href="#">Robot built by MIST students brings glory for Bangladesh</a> </h5>
                                <p class="post-content-text">Donec sit amet neque lectus. Ut vitae turpis justo. Nullam a sodales est, at viverra sem. Mauris vitae pellentesque nisi, sit amet viverra orci.</p>
                                <div class="blog-btn">
                                    <!-- <div class="blog-tags">
                                        <i class="fas fa-tags"></i>
                        ...
                        <div class="single-blog-item">
                            <div class="single-blog-img">
                                <img src="Home/assets/img/codewar.jpg" alt="">
                                <span>October 23, 2020</span>
                            </div>
                            <div class="blog-content">
                                <h5 class="post-heading"><a href="#">New Programming Competition Started For Newbies of MIST</a> </h5>
                                <p class="post-content-text">Donec sit amet neque lectus. Ut vitae turpis justo. Nullam a sodales est, at viverra sem. Mauris vitae pellentesque nisi, sit amet viverra orci.</p>
                                <div class="blog-btn">
                                    <!-- <div class="blog-tags">
                                        <i class="fas fa-tags"></i>
                        ...
                        <div class="single-blog-item">
                            <div class="single-blog-img">
                                <img src="Home/assets/img/webdev.jpg" alt="">
                                <span>April 24, 2020</span>
                            </div>
                            <div class="blog-content">
                                <h5 class="post-heading"><a href="#">Web Development Course Ongoing for the new Enthusiastic Developers</a> </h5>
                                <p class="post-content-text">Donec sit amet neque lectus. Ut vitae turpis justo. Nullam a sodales est, at viverra sem. Mauris vitae pellentesque nisi, sit amet viverra orci.</p>
                                <div class="blog-btn">
                                    <!-- <div class="blog-tags">
                                        <i class="fas fa-tags"></i>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="testimonial-carousel owl-carousel">
                        <div class="single-testimonial-item ">
                            ...
                            <div class="author-details d-flex">
                                <div class="author-img">
                                    <img src="Home/assets/img/user_01.png" alt="">
                                </div>
                        ...
                        <!-- <div class="single-testimonial-item ">
                            ...
                            <div class="author-details d-flex">
                                <div class="author-img">
                                    <img src="Home/assets/img/user_02.png" alt="">
                                </div>
                                <div class="author-content">
                                   <a href="#">Michael Green</a>
                                   <span>Product Manager</span>
                        ...
                        <div class="single-testimonial-item ">
                            ...
                            <div class="author-details d-flex">
                                <div class="author-img">
                                    <img src="Home/assets/img/user_03.png" alt="">
                                </div>
                                <div class="author-content">
                                   <a href="#">Michael Green</a>
                                   <span>Product Manager</span>
            ...
            <div class="brand-carousel owl-carousel">
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="rsz_1walt.jpg" alt=""></a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="rsz_robi.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="rsz_gp.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="rsz_bang.jpg" alt=""></a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="Home/assets/img/brands/5.png" alt=""></a>
                    </div>
                </div>
                <div class="brand-item">
                    <div class="brand-item-inner">
                        <a href="#"><img src="Home/assets/img/brands/6.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
...
<!-- JS -->
   ...
   <!-- Bootstrap.js -->
   <script src="Home/assets/js/bootstrap-4.3.1.min.js"></script>
   <!-- Modernizr.js -->
   <script src="Home/assets/js/vendor/modernizr-3.5.0.min.js"></script>
   <!-- Owl.Carousel.js -->
   <script src="Home/assets/js/vendor/owl.carousel-2.3.4.min.js"></script>
   <script src="Home/assets/js/vendor/owl.carousel2.thumbs.min.js"></script>
   <!-- Waypoints.js -->
   <script src="Home/assets/js/vendor/waypoints-4.0.1.min.js"></script>
   <!-- ColorNip.js -->
   <script src="Home/assets/js/vendor/colornip.min.js"></script>
   <!-- SlickNav.js -->
   <script src="Home/assets/js/vendor/slicknav.min.js"></script>
   <!-- ScrollUp.js -->
   <script src="Home/assets/js/vendor/jquery.scrollUp.min.js"></script>
   <!-- MagnificPopup.js -->
   <script src="Home/assets/js/vendor/magnific-popup.min.js"></script>
